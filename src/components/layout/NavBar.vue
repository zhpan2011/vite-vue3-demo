<template>
  <nav class="navbar is-bold app-navbar animated" :class="{ slideInDown: show, slideOutDown: !show }">
    <div class="navbar-brand">
      ...
      <a class="navbar-item is-hidden-tablet" @click="toggleSidebar({opened: !getters.sidebar.opened})">
              <span class="icon is-small">
                <i class="fas fa-home" v-show="!getters.sidebar.hidden"></i>
              </span>
